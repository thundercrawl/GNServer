...
-- ----------------------------
-- Table structure for t_dingshengCity
-- ----------------------------
DROP TABLE IF EXISTS `t_dingshengCity`;
CREATE TABLE `t_dingshengCity`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for t_dingshengCompany
-- ----------------------------
DROP TABLE IF EXISTS `t_dingshengCompany`;
CREATE TABLE `t_dingshengCompany`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for t_dingshengCartype
-- ----------------------------
DROP TABLE IF EXISTS `t_dingshengCartype`;
CREATE TABLE `t_dingshengCartype`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cartype` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci ,
...
-- ----------------------------
-- Table structure for t_dingsheng
-- ----------------------------
DROP TABLE IF EXISTS `t_dingsheng`;
CREATE TABLE `t_dingsheng`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `kunpengDate` datetime(0) not NULL,
  `city` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci ,
  ...
  `finishpeople` integer,
  `fundsum` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci,
...
-- ----------------------------
-- Table structure for t_kunpengCity
-- ----------------------------
DROP TABLE IF EXISTS `t_kunpengCity`;
CREATE TABLE `t_kunpengCity`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `city` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci ,
  `province` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for t_kunpengCompany
-- ----------------------------
DROP TABLE IF EXISTS `t_kunpengCompany`;
CREATE TABLE `t_kunpengCompany`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `company` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci ,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `modify_time` datetime(0) NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for t_kunpengCartype
-- ----------------------------
DROP TABLE IF EXISTS `t_kunpengCartype`;
CREATE TABLE `t_kunpengCartype`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cartype` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci ,
  `carsalingprice` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci,
  `carinvoiceprice` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci,
...
-- ----------------------------
-- Table structure for t_kunpeng
-- ----------------------------
DROP TABLE IF EXISTS `t_kunpeng`;
CREATE TABLE `t_kunpeng`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `kunpengDate` datetime(0) not NULL,
  `city` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci ,
  `company` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
-- ----------------------------
-- Table structure for t_zhideContract
-- ----------------------------
DROP TABLE IF EXISTS `t_zhideContract`;
CREATE TABLE `t_zhideContract`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `filename` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci ,
  `serialnum` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `contractname` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci,
  `contractusage` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci,
  `signedPart` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci,
  `comments` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci,
  `filedata`     MEDIUMBLOB,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `modify_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- Table structure for t_fundefficientcompany
-- ----------------------------
DROP TABLE IF EXISTS `t_fundefficientcompany`;
CREATE TABLE `t_fundefficientcompany`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `company` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci ,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `modify_time` datetime(0) NULL DEFAULT NULL,
...
INSERT INTO `t_fundefficientcompany` VALUES (1, '鼎盛业务' ,'2018-04-14 20:33:22','2018-04-14 20:33:22');
INSERT INTO `t_fundefficientcompany` VALUES (2, '坤鹏业务' ,'2018-04-14 20:33:22','2018-04-14 20:33:22');
-- ----------------------------
-- Table structure for t_fundefficient
-- ----------------------------
DROP TABLE IF EXISTS `t_fundefficient`;
CREATE TABLE `t_fundefficient`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fundDate` datetime(0) NOT  NULL,
  `fundSource` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `fundSum`  varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci,
  `fundUsage` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci,
  `monthlyFundSum` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci,
  `alreadyLentFundSum` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci,
  `leftFundSum` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `modify_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `t_console_resource` VALUES (101, 'console_10101', '用户管理', 'usermanager', 'setting/usermanagement', 'console_1', 3, 3, 2, '', '菜单管理备注123', 'Y', 'Y', '2018-04-14 20:06:21', '2018-05-08 00:23:39');
...
INSERT INTO `t_console_user_permission` VALUES (1022, 1, 3014, '2018-05-12 09:27:20');
...
INSERT INTO `t_console_user_permission` VALUES (1023, 1, 3024, '2018-05-12 09:27:20');
...
INSERT INTO `t_console_user_permission` VALUES (1024, 1, 3034, '2018-05-12 09:27:20');
...
INSERT INTO `t_console_user_permission` VALUES (1025, 1, 3044, '2018-05-12 09:27:20');
...
INSERT INTO `t_console_user_permission` VALUES (1026, 1, 3054, '2018-05-12 09:27:20');
INSERT INTO `t_console_user_permission` VALUES (1016, 1, 1011, '2018-05-12 09:27:20');
INSERT INTO `t_console_user_permission` VALUES (1017, 1, 1012, '2018-05-12 09:27:20');
INSERT INTO `t_console_user_permission` VALUES (1018, 1, 1013, '2018-05-12 09:27:20');
INSERT INTO `t_console_user_permission` VALUES (1020, 1, 3, '2018-05-12 09:27:20');
INSERT INTO `t_console_user_permission` VALUES (1021, 1, 1, '2018-05-12 09:27:20');
...
INSERT INTO `t_console_user_permission` VALUES (1000011, 2, 3, '2018-05-12 09:27:20');
INSERT INTO `t_console_user_permission` VALUES (1000012, 2, 1, '2018-05-12 09:27:20');
